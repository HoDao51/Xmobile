...
<div class="mt-5 max-w-[1200px] mx-auto px-4">
    <nav class="text-2x1 text-gray-600 mb-4" data-aos="fade-right">
        <ol class="list-reset flex items-center space-x-2">
            ...
            <li>
                <a href="index.php?action=dienthoai" class="text-blue-700 hover:underline font-medium">Điện Thoại</a>
            </li>
        </ol>
    </nav>

  <div class="border-l-2 border-l-red-500 border-r-2 border-r-red-500 mr-[39%] ml-[39%] mb-[20px] p-2" data-aos="zoom-in">
    <h1 class="text-center text-4xl font-semibold text-black">Điện Thoại</h1>
  </div>
  ...
  <!-- Phân trang -->
    <div style="margin-bottom: 20px; margin-top: 20px; text-align: center;">
        <?php for ($i = 1; $i <= $pages; $i++) {
            $link = "index.php?action=dienthoai&page=$i";
            if (!empty($keyword)) {
