...
<header class="sticky top-0 z-[1000] w-full bg-white shadow-md">
  ...
  <nav class="w-full bg-white shadow-md">
    <div class="mx-auto flex max-w-[1265px] items-center justify-between gap-5 px-5 py-[22px]">
      ...
      <!-- Navigation Links -->
      <ul class="flex flex-wrap items-center gap-[39px] text-center text-[14px] font-semibold text-black font-[Poppins,sans-serif]">
      ...
      <div class="flex items-center gap-4">
        <form method="GET" action="index.php" class="relative flex h-[42px] w-[300px] items-center rounded-full border border-black/10 bg-white shadow-sm">
      ...
      <div class="flex items-center gap-[18px]">
        ...
        <div class="relative z-[1001]">
          <button id="profileBtn" class="p-0" aria-label="User profile">
            <img src="images/menu/account.svg" alt="Profile" class="w-[45px] object-contain aspect-square" />
          </button>
          <div id="dropdownMenu" class=" absolute right-0 mt-2 hidden min-w-[160px] rounded-lg border border-gray-200 bg-white shadow-lg">
            <a href="index.php?action=xemtaikhoan" class="block px-4 py-2 text-sm text-gray-800 hover:bg-gray-100">Xem tài khoản</a>
            <a href="../logout.php" class="block px-4 py-2 text-sm text-gray-800 hover:bg-gray-100">Đăng xuất</a>
          </div>
        </div>
      </div>
    </div>
