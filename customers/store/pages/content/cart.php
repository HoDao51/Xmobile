                ...
                <?php }else{ ?>
                    ...
                    ?>
                        <tr style="border-bottom: 1px solid #bdc0cb;">
                            ...
                            <td >
                                <input type="text" name="cart[<?php echo $cart['Cart_id']; ?>][<?php echo $cart['Product_id']; ?>]" value="<?php echo $cart['Quantity']; ?>" size="2" style="text-align: center; border: 1px solid #000; border-radius: 3px; padding: 5px;">
                            </td>
