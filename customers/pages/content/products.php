<?php
  ...
  $sqlCount = "SELECT COUNT(*) AS total FROM products WHERE Name LIKE '%$keyword%'";
...
<div class="mt-5 max-w-[1200px] mx-auto px-4">
  <nav class="text-2x1 text-gray-600 mb-4" data-aos="fade-right">
        <ol class="list-reset flex items-center space-x-2">
            ...
            <li>
                <a href="#" class="text-blue-700 hover:underline font-medium">kết quả tìm kiếm của (<?php echo $keyword?>)</a>
            </li>
        </ol>
    </nav>
  ...
  <!-- Phân trang -->
    <div style="margin-bottom: 20px; margin-top: 20px; text-align: center;">
        <?php for ($i = 1; $i <= $pages; $i++) {
            $link = "index.php?action=sanpham&page=$i";
            if (!empty($keyword)) {
